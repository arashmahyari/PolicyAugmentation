...
from Inductive_Matrix_Completion import IMC
            ...
            for _ in range(total_timesteps):
                ...
                if self.my_counter %10==1:
                    if self.counter_success<4:
                        ...
                        self.Predicted_Q = IMC(self.Q,self.Nq,self.action_features,self.state_features,1)        
                ...
                if self.my_counter>1:
                    self.UpdateQ(self.current_state,self.new_state,env_action, rew)       
                ...
                if new_obs[0]>0.48 or done:
                    if self.episode_num %50==0:
                        print(self.episode_num, self.my_counter, '--> ', each_reward_episode, new_obs[0], done)
